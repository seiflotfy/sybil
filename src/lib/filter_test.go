...
func testIntLt(test *testing.T) {
	...
	querySpec := sybil.QuerySpec{QueryDetails: sybil.QueryDetails{Filters: filters, Aggregations: aggs}}
...
func testIntNeq(test *testing.T) {
	...
	querySpec := sybil.QuerySpec{QueryDetails: sybil.QueryDetails{Filters: filters, Aggregations: aggs, Groups: groupings}}
